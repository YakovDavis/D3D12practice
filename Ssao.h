...
public:
    ...
    void SetPSOs(ID3D12PipelineState* ssaoPso, ID3D12PipelineState* ssaoHorzBlurPso, ID3D12PipelineState* ssaoVertBlurPso);
...
private:
    ...
    ID3D12PipelineState* mHorzBlurPso = nullptr;
    ID3D12PipelineState* mVertBlurPso = nullptr;
